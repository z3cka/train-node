...
this['JST']['app/templates/story.html'] = function(obj){
...
define('modules/stories',['app', 'lodash', 'backbone'], function(app, _, Backbone) {
...
require.config({
  ...
  paths: {
    ...
    "socket.io": "../assets/js/libs/socket.io.min"
  },
